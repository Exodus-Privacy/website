...
# Qui sommes nous ?
Exodus Privacy est une association française à but non-lucratif, régie la loi de 1901. Cette organisation est animée par des hacktivists dont le but est la protection de la vie privée.
...
<div class="row justify-content-md-center">
    ...
    <div class="col-md-3 mt-3 text-center">
        ...
        <div class="card-body">
            ...
            D<p class="small">Developeuse principale d’εxodus.</p>
        </div>
    </div>
    <div class="col-md-3 mt-3 text-center">
        <i class="far fa-3x fa-user mt-2 ml-auto mr-auto text-primary"></i>
